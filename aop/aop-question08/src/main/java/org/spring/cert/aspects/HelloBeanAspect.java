...
public class HelloBeanAspect {
    ...
    @Before("execution(* org..HelloBean.formatData(..))")
    ...
    @After("execution(* org..HelloBean.formatData(..))")
    ...
    @AfterReturning(value = "execution(* org..HelloBean.formatData(..))", returning = "returnValue")
    ...
    @AfterThrowing(value = "within(org..HelloBean)", throwing = "exception")
