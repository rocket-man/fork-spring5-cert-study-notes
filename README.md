...
**mvc** -> web layer, DispatcherServlet, annotations like @Controller, @RequestMapping, @GetMapping, @RequestParam, @PathVariable
  - (param types) => WebRequest, NativeWebRequest, ServletRequest, HttpSession, ServletResponse, PushBuilder, Principal, HttpMethod, Locale, TimeZone, InputStream, OutputStream, HttpEntity, Map, Model, RedirectAttributes, Errors, BindingResult, SessionStatus, @SessionAttributes 
